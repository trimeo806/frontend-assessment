# SkyBook — Documentation Index

This directory contains all technical and process documentation for the SkyBook flight booking assessment project.
...
| ------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [architecture.html](./architecture.html) ★ | **System architecture (rendered)** — 4 interactive Mermaid diagrams (system layers, booking sequence, Zustand store, component tree), library selection rationale, rendering strategy, Server Actions, route guard pattern |
| [architecture.md](./architecture.md)       | **System architecture (source)** — same content as the HTML file, in plain Markdown                                                                                                                                        |
| [workflow.html](./workflow.html) ★          | **Development workflow (rendered)** — 10-phase Mermaid flowchart with colour-coded phase groups, phase cards, and key learnings                                                                                            |
| [workflow.md](./workflow.md)               | **Development workflow (source)** — same content as the HTML file, in plain Markdown                                                                                                                                       |
...
> ★ Open HTML files directly in a browser — diagrams render without any extension or tool.
