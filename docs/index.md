...
| ------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [architecture.md](./architecture.md) | **System architecture** — 4 Mermaid diagrams (system layers, booking sequence, Zustand store, component tree), library selection rationale, rendering strategy, Server Actions, route guard pattern |
| [workflow.md](./workflow.md)         | **Development workflow** — 10-phase Mermaid flowchart with colour-coded phase groups, phase cards, and key learnings                                                                                |
